...
<head>
    ...
    <title>About Content Management</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        @endif
                        <h4 class="fw-bold py-3 mb-4">Manage About Us Content</h4>
                                        ...
                                        <div class="card-body demo-vertical-spacing demo-only-element">
                                            <div class="mb-3">
                                                ...
                                                <input id="defaultInput" class="form-control" type="text"
                                                    placeholder="Enter title" name="aboutTitle" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="defaultInput" class="form-label">Sub Text</label>
                                                <input id="defaultInput" class="form-control" type="text"
                                                    placeholder="Enter sub text" name="aboutSubtext" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Select About Us Image</label>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form action="{{ route('teamMembers.store') }}" method="POST"
                                        ...
                                        <div class="card-body demo-vertical-spacing demo-only-element">
                                            ...
                                            <label for="socialMediaSwitches" class="form-label">Add Social Media</label>
                                            <div class="mb-3" style="display: flex; flex-wrap: wrap; gap: 10px;">
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="facebook-f" id="fb">
                                                    <label class="form-check-label" for="fb">Facebook</label>
                                                </div>
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="twitter" id="twt">
                                                    <label class="form-check-label" for="twt">X</label>
                                                </div>
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="linkedin-in" id="li">
                                                    <label class="form-check-label" for="li">LinkedIn</label>
                                                </div>
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="youtube" id="yt">
                                                    <label class="form-check-label" for="yt">YouTube</label>
                                                </div>
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="instagram" id="ig">
                                                    <label class="form-check-label" for="ig">Instagram</label>
                                                </div>
                                                <div class="form-check form-switch" style="margin-right: 20px;">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="social_media[]" value="tiktok" id="tt">
                                                    <label class="form-check-label" for="tt">TikTok</label>
                                                </div>
                                            </div>
                                            <button class="btn btn-primary d-grid w-40"
                                                style="background-color: #63b701; border:none" type="submit">
                                                Add Member
                                            </button>
                                        </div>
                                    </form>
